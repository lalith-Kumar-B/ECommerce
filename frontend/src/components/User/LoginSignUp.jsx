...
const LoginSignUp = () => {
  ...
  }, [dispatch, error, alert, navigator, isAuthenticated, redirect]);
  ...
  return (
    <Fragment>
      {loading ? (
        ...
        <Fragment>
          <MetaData title={"Authantication"}/>
          <div className="LoginSignUpContainer">
            <div className="LoginSignUpBox">
              <div>
                <div className="login_signUp_toggle">
                  <div onClick={(e) => switchTabs(e, "login")}>
                    <p>LOGIN</p>
                  </div>
                  <div onClick={(e) => switchTabs(e, "register")}>
                    <p>REGISTER</p>
                  </div>
                </div>
